...
export default function RecentSearches() {
    ...
    return (
        <Grid container sx={{width: '66vw', overflow:"scroll", marginLeft: "10px"}} spacing={1}>
            {/* <Grid item container>
            ...
            {recentSearches?.map((search, i)=>(
                ...
                {search.bathrooms?.map((bathroom, j)=>(
                    <Grid item container key={j}>
                        <RecentSearchBathroom bathroom={bathroom} originName={search.origin_name} originAddress={search.origin_address}/>
                    </Grid>
                ))}
                </>   
                </>
